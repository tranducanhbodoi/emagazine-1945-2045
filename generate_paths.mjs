...
export const PROVINCES_34 = [
  // ==========================================
  // NHÓM 1: 11 ĐƠN VỊ HÀNH CHÍNH KHÔNG THỰC HIỆN SẮP XẾP (GIỮ NGUYÊN)
  // ==========================================
  {
    id: 1,
    name: "TP. Hà Nội",
    shortName: "TP. Hà Nội",
    type: "Thành phố (Giữ nguyên)",
    isMerged: false,
    area: "3.359,82",
  ...
  // ==========================================
  // NHÓM 2: 23 ĐƠN VỊ HÀNH CHÍNH CẤP TỈNH MỚI (SAU SẮP XẾP, SÁP NHẬP)
  // ==========================================
  {
    id: 12,
    name: "Tuyên Quang (Tuyên Quang + Hà Giang)",
    shortName: "Tuyên Quang",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "13.793,50",
    population: "1.765.270",
  ...
  {
    id: 14,
    name: "Thái Nguyên (Thái Nguyên + Bắc Kạn)",
    shortName: "Thái Nguyên",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "8.375,21",
    population: "1.709.489",
  ...
  },
  {
    ...
    oldNames: ["Phú Thọ", "Vĩnh Phúc", "Hòa Bình", "Hoà Bình"]
  },
  {
    id: 16,
  ...
  {
    id: 17,
    name: "Hưng Yên (Hưng Yên + Thái Bình)",
    shortName: "Hưng Yên",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "2.514,81",
  ...
  {
    id: 18,
    name: "TP. Hải Phòng (TP. Hải Phòng + Hải Dương)",
  ...
  {
    id: 19,
    name: "Ninh Bình (Ninh Bình + Nam Định + Hà Nam)",
    shortName: "Ninh Bình",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "3.942,62",
    population: "4.412.264",
    oldNames: ["Ninh Bình", "Nam Định", "Hà Nam"]
  },
  {
    id: 20,
    name: "Quảng Trị (Quảng Bình + Quảng Trị)",
    shortName: "Quảng Trị",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "12.700,00",
    population: "1.870.845",
    oldNames: ["Quảng Bình", "Quảng Trị"]
  },
  {
    id: 21,
    name: "TP. Đà Nẵng (TP. Đà Nẵng + Quảng Nam)",
  ...
  {
    id: 22,
    name: "Quảng Ngãi (Quảng Ngãi + Kon Tum)",
  ...
  {
    id: 23,
    name: "Gia Lai (Gia Lai + Bình Định)",
    shortName: "Gia Lai",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "21.576,53",
  ...
  {
    id: 24,
    name: "Khánh Hòa (Khánh Hòa + Ninh Thuận)",
    shortName: "Khánh Hòa",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "8.555,86",
  ...
  {
    id: 25,
    name: "Lâm Đồng (Lâm Đồng + Bình Thuận + Đắk Nông)",
    shortName: "Lâm Đồng",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "24.233,07",
    population: "3.872.999",
    oldNames: ["Lâm Đồng", "Bình Thuận", "Đắk Nông"]
  },
  {
    id: 26,
    name: "Đắk Lắk (Đắk Lắk + Phú Yên)",
    shortName: "Đắk Lắk",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "18.096,40",
    population: "3.346.851",
  ...
  },
  {
    ...
    oldNames: ["Hồ Chí Minh", "Bình Dương", "Bà Rịa - Vũng Tàu", "Bà Rịa Vũng Tàu"]
  },
  {
    id: 28,
    name: "Đồng Nai (Đồng Nai + Bình Phước)",
    shortName: "Đồng Nai",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "12.737,18",
  ...
  {
    id: 29,
    name: "Tây Ninh (Tây Ninh + Long An)",
    shortName: "Tây Ninh",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "8.536,44",
  ...
  {
    id: 30,
    name: "TP. Cần Thơ (TP. Cần Thơ + Sóc Trăng + Hậu Giang)",
    shortName: "TP. Cần Thơ",
    type: "Thành phố sáp nhập mới",
    isMerged: true,
    area: "6.360,83",
    population: "4.199.824",
    oldNames: ["Cần Thơ", "Sóc Trăng", "Hậu Giang"]
  },
  {
    id: 31,
  ...
  {
    id: 34,
    name: "An Giang (An Giang + Kiên Giang)",
    shortName: "An Giang",
    type: "Tỉnh sáp nhập mới",
    isMerged: true,
    area: "9.888,91",
...
// Width and height for optimal SVG viewBox
const width = 740;
const height = 980;
...
const processedFeatures = rawData.features.map(f => {
  ...
  const unit = PROVINCES_34.find(p => p.oldNames.some(o => cleanName.includes(o) || o.includes(cleanName)));

  return {
    id: f.properties.OBJECTID || f.properties.Ma,
    name: name,
    unitId: unit ? unit.id : 0,
    unitName: unit ? unit.name : name,
    shortName: unit ? unit.shortName : name,
    path: path,
    bounds: bounds,
    centroid: centroid
  };
...
const output = {
  ...
  units: PROVINCES_34,
  provinces: processedFeatures
};

fs.writeFileSync('src/data/vietnam-map-paths.json', JSON.stringify(output));
console.log('Regenerated src/data/vietnam-map-paths.json with exact 34 VGP provinces.');
